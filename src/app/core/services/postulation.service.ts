...
import { HttpListService } from '../htttp/http-list.service';
...
export class PostulationService {
    ...
    private baseUrlLocal = 'http://localhost:3000'
    ...
    public getOffers(queryParams?: CollectionQueryParams) {
        return this.httpListService
            .get<any>(this.baseUrlLocal + '/work-offers', queryParams);
    }

    public getOffersHistory(queryParams?: CollectionQueryParams) {
        return this.httpListService.get<any>(this.baseUrlLocal + '/work-offers-history', queryParams);
    }
